...
export const BACKGROUNDS = [
  { id: 'gravewatch', name: '墓园守夜者', story: '曾替骸骨族看守一片被王国划作“待净化土地”的墓园。第七十个夜晚，拆墓队举着圣火抵达；它带走会说话的墓碑，来到地牢为亡者争一块不必缴税的安眠地。' },
  { id: 'caravan', name: '地底商队护卫', story: '原本替往来魔物聚落的地底商队护送盐、骨器和幼兽。王国巡逻队把整支商队登记成战利品后，只剩它和一张拒绝作废的货单。' },
  { id: 'arena', name: '铁笼胜者', story: '在供人类贵族取乐的黑市斗场里活过许多轮厮杀，学会从观众的呼吸判断危险。逃出铁笼后，它决定把本领留给愿意叫它名字、而非编号的魔物同伴。' },
  { id: 'archive', name: '地穴抄写员', story: '曾替地穴学者誊写被教会列为禁书的魔物史。王国烧掉档案馆时，它抢出一页会自行续写的手稿；那一页如今把这座地牢称作“下一章”。' },
  { id: 'border', name: '边境遗民', story: '故乡在王国清剿中化为焦土。它记不清聚落原来的名字，却记得每一面参与围攻的旗帜，并坚持把这些旗帜倒着挂进新家的走廊。' },
  { id: 'pilgrim', name: '暗路朝圣者', story: '沿着被圣堂砸毁的魔物神龛一路来到地牢。它相信光照不到的地方并非邪恶，只是王国的地图绘制员不肯支付加班费。' },
  { id: 'workshop', name: '废炉学徒', story: '在一座哥布林锻造坊里长大，能凭敲击声判断金属裂纹。王国征走熔炉又嫌成品不够神圣，它便来地牢寻找一团只听自己人号令的火。' },
  { id: 'deserter', name: '部族拒征者', story: '旧部族准备用几只幼兽换取王国暂缓清剿，它拒绝签字，连夜带着幼兽逃走。通缉令称它为叛徒；获救的魔物称它为英雄。' },
  { id: 'dreamer', name: '梦境漂流者', story: '醒来时身边只有一枚陌生钥匙和一段被王国法师封存的记忆。每深入地牢一层，那段记忆就更清晰，也更像某个魔物聚落被抹去前的最后一天。' },
  { id: 'undertaker', name: '荒原收殓人', story: '替清剿后的魔物收敛遗骸多年，从尸骨上的伤痕学会战斗。它不敬畏死亡——战死者下轮还能回来——只厌恶让同伴死得连名字都没有。' },
  { id: 'exile', name: '旧巢放逐者', story: '因拒绝把弱小同族留给王国追兵而被旧巢放逐。它保留着断裂的巢徽，等待证明守护同伴比服从一位胆怯的首领更配称作忠诚。' },
  { id: 'deepborn', name: '深层原住民', story: '出生在王国地图尚未标出的地底深处，熟悉岩层移动的声音。它说这座地牢并非突然出现，只是地面上的人终于闯得足够深，发现地下也住着人。' },
];
